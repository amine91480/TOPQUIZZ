...
import com.amine.amarouche.model.User;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (GAME_ACTIVITY_REQUEST_CODE == requestCode && RESULT_OK == resultCode) {
            ...
            System.out.println("Résultat 1: "+ score);
            System.out.println("Résultat 2: "+ mUser.getFirstName());
        }
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                System.out.println("Résultat 3 : "+ firstname);
            }
    ...
    private void beginUser(){
        ...
        if (null != firstname) {
            ...
            String fulltext = "Bon retour parmis nous "+ firstname+ " ! Peux-tu faire mieux que ton ancien score qui était de :  "+score+"/5 ? Esseye donc !";
